...
<!--			 <a href="checkoutstep.jsp">Thanh Toán</a>-->
                    <fieldset>
                        ...
                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                            ...
                            <input type="hidden" name="business" value="phamducmanh.ptit@gmail.com">

                            <!-- tham số cmd có giá trị _xclick chỉ rõ cho paypal biết là người dùng nhất nút thanh toán -->
                            <input type="hidden" name="cmd" value="_xclick">

                            <!-- Thông tin mua hàng. -->
                            <input type="hidden" name="item_name" value="BILL IN PTITECOMMERCE">
                            <!--Trị giá của giỏ hàng, vì paypal không hỗ trợ tiền việt nên phải đổi ra tiền $-->
                            <input type="number" name="amount" placeholder="Nhập số tiền vào" value="<%=cart.totalCart()%>" style="display: none">
                                        <!--Loại tiền-->
                            ...
                            <!-- Nút bấm. -->
                            <input type="submit" name="submit" value="Thanh toán quay Paypal" style="color: #fff;
                                                                                                    background: #FF7000;
